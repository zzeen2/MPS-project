...
exports.buildApiStatsQuery = buildApiStatsQuery;
exports.buildApiChartQuery = buildApiChartQuery;
exports.buildApiKeysQuery = buildApiKeysQuery;
function buildApiStatsQuery(period) {
...
function buildApiChartQuery(period) {
    switch (period) {
        case '24h':
            return `
        SELECT 
...
function buildApiKeysQuery(dto) {
...
//# sourceMappingURL=system.queries.js.map