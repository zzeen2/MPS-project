...
exports.buildRealtimeTransactionsQuery = exports.buildRealtimeTopTracksQuery = exports.buildRealtimeApiStatusQuery = exports.buildCategoryTop5Query = void 0;
const drizzle_orm_1 = require("drizzle-orm");
const buildCategoryTop5Query = (ymYear, ymMonth, tz, limit = 5) => (0, drizzle_orm_1.sql) `
  WITH month_range AS (
    SELECT 
  ...
  ORDER BY rank ASC
`;
exports.buildCategoryTop5Query = buildCategoryTop5Query;
const buildRealtimeApiStatusQuery = (limit = 5) => (0, drizzle_orm_1.sql) `
  ...
  LIMIT ${limit}
`;
exports.buildRealtimeApiStatusQuery = buildRealtimeApiStatusQuery;
const buildRealtimeTopTracksQuery = (limit = 10) => (0, drizzle_orm_1.sql) `
  ...
  LIMIT ${limit}
`;
exports.buildRealtimeTopTracksQuery = buildRealtimeTopTracksQuery;
const buildRealtimeTransactionsQuery = (limit = 3) => (0, drizzle_orm_1.sql) `
  WITH mock_tx AS (
    SELECT 
...
`;
exports.buildRealtimeTransactionsQuery = buildRealtimeTransactionsQuery;
